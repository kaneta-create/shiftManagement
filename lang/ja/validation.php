...
return [
    ...
    */
    ...
    // 'employee_number.exists' => 'この社員番号は登録されていません。',
    ...
    */
    ...
    'attributes' => [
        ...
        'authority' => '権限',
        '月曜日.start_time' => '月曜日の出勤時間',
        '月曜日.end_time' => '月曜日の退勤時間',
        '火曜日.start_time' => '火曜日の出勤時間',
        '火曜日.end_time' => '火曜日の退勤時間',
        '水曜日.start_time' => '水曜日の出勤時間',
        '水曜日.end_time' => '水曜日の退勤時間',
        '木曜日.start_time' => '木曜日の出勤時間',
        '木曜日.end_time' => '木曜日の退勤時間',
        '金曜日.start_time' => '金曜日の出勤時間',
        '金曜日.end_time' => '金曜日の退勤時間',
        '土曜日.start_time' => '土曜日の出勤時間',
