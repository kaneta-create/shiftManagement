                            ...
                            <table class="min-w-full bg-white border border-gray-300">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- 他のヘッダ要素 -->
                                        <th v-for="(day, index) in dayInfos" :key="index" class="border border-gray-300 bg-gray-100">
                                            ...
                                            <div class=" text-center bg-gray-100">{{ day.day_of_week }}</div>
                                        </th>
                                        <th class="text-center border text-xs border-gray-300 bg-gray-100">
