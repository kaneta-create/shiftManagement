                                ...
                                <tr v-for="(employee, index) in props.employees" :key="employee.id" :class="{ 'even:bg-gray-50 odd:bg-whit': index % 2 === 1  }">
                                    ...
                                    <td class="px-4 py-3 border-b-2 border-gray-200">
                                        <Link as="button" :href="route('defaultShifts.edit', { defaultShift: employee.id })" 
                                            ...
                                            class="text-white text-nowrap border-b-2 bg-indigo-500 mt-1 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded flex items-center justify-center">
                                    ...
                                    <td class="border-b-2 border-gray-200">
                                        <button @click="deleteEmployee(employee.id)" 
                                                class="text-white border-b-2 bg-red-400 mt-1 border-0 py-2 px-2 focus:outline-none hover:bg-red-500 rounded flex items-center justify-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
